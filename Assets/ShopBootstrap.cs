...
public class ShopBootstrap : MonoBehaviour
{
    ...
    {
        OpenSkinChecker openSkinsChecker = new OpenSkinChecker(_persistentPlayerData);
        SelectedSkinsChecker selectedSkinChecker = new SelectedSkinsChecker(_persistentPlayerData);
